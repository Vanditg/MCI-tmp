...
fig.update_xaxes(title_text="Generations", row=1, col=3)
fig.update_xaxes(title_text="Generations", row=2, col=3)
fig.update_xaxes(title_text="Time - Period", row=1, col=4)
fig.update_xaxes(title_text="Time - Period", row=2, col=4)
...
fig.update_yaxes(title_text="Generation Cells", row=1, col=2)
fig.update_yaxes(title_text="Generation Cells", row=2, col=2)
fig.update_yaxes(title_text="Generation Cells", row=1, col=1)
fig.update_yaxes(title_text="Generation Cells", row=2, col=1)
fig.update_yaxes(title_text="Cohort Number", row=1, col=3)
fig.update_yaxes(title_text="Cohort Number", row=2, col=3)
fig.update_yaxes(title_text="Cohort Number", row=1, col=4)
fig.update_yaxes(title_text="Cohort Number", row=2, col=4)
